...
public class MathStudent extends Students implements StudentInterface{
	
	String[] sub= {"trigonometry", "statistics","calculus"};
	int[] mark= new int[3];

	public MathStudent(int sid, String name, String address, int age, String courseName, String collegeName, int[] mark) {
